...
public class Modifzpassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_modifzpassword);
    ...
    public String AddUser() {
        ...
        String method = "EditLoginPassword";
        SoapObject request = new SoapObject(nameSpace, method);

        request.addProperty("PhoneId", ID);
        request.addProperty("OldLoginPwd",OriginalPassword.getText().toString().trim());
        request.addProperty("NewLoginPwd",NewPassword.getText().toString().trim());
